...
public class WSApplicationError {
	...
	/**
	 * Retrieves error information from the database. If an error is not found
	 * in the database, a generic error will be created.
	 * 
	 * @param errorCode
	 *            The error code to retrieve from the database
	 */
	...
	public String generateFormattedErrorMsg() {
		...
		if (internalError != null) {
			...
			json += "\"friendlyMessage\": \""
					+ internalError.getFriendlyMessage() + "\", \n";
		}
