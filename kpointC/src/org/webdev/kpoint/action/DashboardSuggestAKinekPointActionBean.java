...
@UrlBinding("/DashboardSuggestAKinekPoint.action")
public class DashboardSuggestAKinekPointActionBean extends AccountDashboardActionBean {
    ...
    public Resolution view() throws UnsupportedEncodingException {
		return UrlManager.getADBSuggestAKP();
	}
    ...
    public Resolution createProspect() throws Exception {
    	...
    	if (notifyMe)
    		prospect.setNotifyEmailAddress(activeUser.getEmail());
