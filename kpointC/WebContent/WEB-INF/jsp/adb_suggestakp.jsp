...
<s:layout-render name="/WEB-INF/jsp/accountdashboard.jsp">
	<s:layout-component name="contents">
		<link rel="stylesheet" href="resource/css/pages/dashboard/dashboard-suggestakp.css" type="text/css" media="screen,projection" />
		...
		<!-- CONTENT -->
			...
			<s:link name="returnToSearch" beanclass="org.webdev.kpoint.action.ChooseDefaultKinekPointActionBean" class="buttonLink" id="returnLink" >Return to Search</s:link>
		
			<div id="errors"></div>
			<stripes:errors/>
			<stripes:messages/>
		
			<s:form name="suggestAKP" id="suggestAKP" action="/DashboardSuggestAKinekPoint.action" focus="">
				<div id="prospects">						
					<div id="prospectContents">
						<table class="superplain form">
							...
							<tr>
								<td>
									<div id="notifyMeDiv">
										<s:checkbox name="notifyMe" id="notifyMe" class="checkbox" checked="${actionBean.notifyMe}"/>
										<s:label id="notifyMeLabel" for="prospect.notify" class="suggestkpnotifyme">Notify me when KP is available</s:label>
									</div>
								</td>
								<td>
								</td>
