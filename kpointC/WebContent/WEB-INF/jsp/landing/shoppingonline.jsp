...
<meta name="keywords" content="Kinek, Shopping Online, Shipping, alternative, not home, safe deliveries" />
<meta name="description" content="shopping online - embrace safe deliveries by shipping to a local KinekPoint" />

<!-- STYLESHEETS -->
<link rel="stylesheet" href="resource/css/common/messages.css" type="text/css" media="screen,projection" />
<link rel="stylesheet" href="resource/css/pages/landing/shoppingOnline/shoppingonline.css" type="text/css" media="screen,projection" />

<!--[if IE 8]>
	<link rel="stylesheet" media="screen" type="text/css" href="resource/css/pages/landing/shoppingOnline/shoppingonline-ie8.css"  />
<![endif]-->
<!--[if lte IE 7]>
	<link rel="stylesheet" media="screen" type="text/css" href="resource/css/pages/landing/shoppingOnline/shoppingonline-ie7.css"  />
<![endif]-->
...
<body>
  <div id="container">
	<!-- start header -->
	<div id="header">
		<div id="heading">Shopping Online?</div>
		<div id="subheading1">8 out of 10 people are not home during delivery hours.</div>
		<div id="subheading2"> Are you one of them?</div>				
	</div>
	<!-- end header -->
	
	<!-- start maincontent -->
	<div id="maincontent">
		<div id="maincontentheadertext">Embrace safe deliveries by shipping to a local KinekPoint.</div>
		<div id="maincontentsearchtext">Enter your ZIP code to find a secure KinekPoint location near you.</div>
		...
		<div id="maincontentfootertxt">
			Kinek's nationwide network of secure KinekPoints will receive your online orders, keep them safe, and
			notify you when they arrive.
		</div>
		<div id="kplogo">
			<a href="https://www.kinek.com">
				<img src="resource/images/landing/shoppingOnline/shoppingonline_kp_logo.gif" alt="Kinek"  />						
			</a>
	...
	<div id="footer">
		&#169; Copyright 2010&nbsp; 
			<span class="bullet"><img src="resource/images/landing/shoppingOnline/shoppingonline_bullet.jpg" /></span>&nbsp;
